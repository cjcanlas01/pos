...
<div id="inserthere" class="container-fluid" style="position: absolute; float: left; clear: left;"></div>
</div>
<!-- Modal -->
               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                           <input required style="text-align: right" type="text" id="s_netamountdue" onfocusout="maskNum(this, this.value)" onfocus="unmaskNum(this, this.value)" name="lessdiscount" name="netamountdue" class="form-control" placeholder="" readonly>
                           <div class="help-block with-errors errorinput"></div>
                        </div>
                     </div>
                     <div class="form-group row">
         ...
         success:function(data)
         {
           ...
           for(var i = 0; i < data.length; i++)
           {
               ...
               if(i==0 || i%4==0) {
                   var tmp = divID;
                   //str = result[i].image;
                   //var newtmp = str.replace("http://myonlinepos.kgconsult-ph.com/home1/kgconsul/public_html/myonlinepos", "");
                   $("#inserthere").append("<br />");
                   $("#inserthere").append("<div class='row text-center' style='' id='"+ divID +"'></div>");
                   $("#"+ divID +"").append("<div class='col-md-3' style='height: 170px; width: 25%; margin: 0px 0px 0px 0px;'><span id='"+ spanIDp_id  +"' style='display: none;'>"+ result[i].productid +"</span><span id='"+ spanIDp_up  +"' style='display: none;'>"+ result[i].unitprice +"</span><span id='"+ spanIDc_inv  +"' style='display: none;'></span><img id='"+ btnID +"' onclick='clickHandler(this)' style='height: 100%; width: 100%;' value='' data-toggle='modal' data-target='#optionmodal' src='"+ result[i].image +"' alt=''/><span style='font-size: 25px;' id='"+ spanIDp_n +"'>"+ capitalizeFirstLetter(result[i].productname) +"</span></div>");
                   console.log(result[i].image);
               }
               else {
                   //str = result[i].image;
                   //var newtmp = str.replace("http://myonlinepos.kgconsult-ph.com/home1/kgconsul/public_html/myonlinepos", "");
                   $("#"+ tmp +"").append("<div class='col-md-3' style='height: 170px; width: 25%; margin: 0px 0px 0px 0px;'><span id='"+ spanIDp_id  +"' style='display: none;'>"+ result[i].productid +"</span><span id='"+ spanIDp_up  +"' style='display: none;'>"+ result[i].unitprice +"</span><span id='"+ spanIDc_inv  +"' style='display: none;'></span><img id='"+ btnID +"' onclick='clickHandler(this)' style='height: 100%; width: 100%;' value='' data-toggle='modal' data-target='#optionmodal' src='"+ result[i].image +"' alt=''/><span style='font-size: 25px;' id='"+ spanIDp_n +"'>"+ capitalizeFirstLetter(result[i].productname) +"</span></div>");
                   console.log(result[i].image);
               }
           }
         }
        ...
        prodelem = jQuery.ajax({
           ...
           success:function(data)
           {
               ...
               for(var i = 0; i < data.length; i++)
               {
                   ...
                   if(i==0 || i%4==0) {
                       var tmp = divID;
                       var newtmp = result[i].image;
                       var final = newtmp.replace("/home1/kgconsul/public_html/myonlinepos/webroot", "");
                       $("#inserthere").append("<br />");
                       $("#inserthere").append("<div class='row text-center' style='' id='"+ divID +"'></div>");
                       $("#"+ divID +"").append("<div class='col-md-3' style='height: 170px; width: 25%; margin: 0px 0px 0px 0px;'><span id='"+ spanIDp_id  +"' style='display: none;'>"+ result[i].productid +"</span><span id='"+ spanIDp_up  +"' style='display: none;'>"+ result[i].unitprice +"</span><span id='"+ spanIDc_inv  +"' style='display: none;'></span><img id='"+ btnID +"' onclick='clickHandler(this)' style='height: 100%; width: 100%;' value='' data-toggle='modal' data-target='#optionmodal' src='"+ final +"' alt=''/><span style='font-size: 25px;' id='"+ spanIDp_n +"'>"+ capitalizeFirstLetter(result[i].productname) +"</span></div>");
                       console.log(final);
                   }
                   else {
                       str = result[i].image;
                       var final = str.replace("/home1/kgconsul/public_html/myonlinepos/webroot", "");
                       $("#"+ tmp +"").append("<div class='col-md-3' style='height: 170px; width: 25%; margin: 0px 0px 0px 0px;'><span id='"+ spanIDp_id  +"' style='display: none;'>"+ result[i].productid +"</span><span id='"+ spanIDp_up  +"' style='display: none;'>"+ result[i].unitprice +"</span><span id='"+ spanIDc_inv  +"' style='display: none;'></span><img id='"+ btnID +"' onclick='clickHandler(this)' style='height: 100%; width: 100%;' value='' data-toggle='modal' data-target='#optionmodal' src='"+ final +"' alt=''/><span style='font-size: 25px;' id='"+ spanIDp_n +"'>"+ capitalizeFirstLetter(result[i].productname) +"</span></div>");
                       console.log(final);
                   }
               }
