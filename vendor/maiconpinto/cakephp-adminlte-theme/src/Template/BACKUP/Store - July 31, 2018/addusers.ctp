                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="username" required class="form-control" placeholder="example123">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
                <table id="userstable" class="table table-bordered table-hover" style="width: 100%">
                    <thead>
                        <tr>
                            <td style="width: 150px; font-weight: 1000">ID</td> <!-- 0 -->
                            <td style="width: 150px; font-weight: 1000">Username</td>
                            <td style="width: 150px; font-weight: 1000">Password</td> <!-- 2 -->
                            <td style="width: 150px; font-weight: 1000">Name</td>
                            <td style="width: 150px; font-weight: 1000">Position</td>
                            <td style="width: 150px; font-weight: 1000">Role</td> <!-- 5 -->
