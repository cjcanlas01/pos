      ...
      <div class="row">
        <div class="col-md-5">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form action="<?php echo $this->Url->build(array('controller' => 'Store', 'action' => 'addproductinv')); ?>" method="post" data-toggle="validator" role="form">
                    <div class="row">
                        <div class="col-md-12">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="row">
            <div class="col-md-12">
                <form action="<?php echo $this->Url->build(array('controller' => 'Store', 'action' => 'updateprod')); ?>" method="post" data-toggle="validator" role="form">
